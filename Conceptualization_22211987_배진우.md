...
* **View Transaction History :** 사용자의 거래목록과 상세상태를 확인
* **Confirm Pickup :** 오프라인 대면 시 물품의 실물 상태를 확인하고 수령을 인증하여 대여/매매 계약을 시작
* **Confirm Return :** 대여 종료 후 물품 상태를 확인하고 반납을 최종 승인하여 거래를 종결
...
<table>
  ...
  <tr><td><b>Dynamics</b></td><td>등록되지 않은 사용자가 자신의 정보를 등록하려고 할때 작동한다.</td></tr>
...
<table>
  ...
  <tr><td><b>Dynamics</b></td><td>수요자가 예약 신청을 완료한 후, 공급자가 예약 요청 목록을 확인할 때 발생함.</td></tr>
...
### 11) View Transaction History
<table>
  <tr><td><b>Purpose</b></td><td>사용자가 참여한 모든 매매 및 대여 거래의 현재 진행 상태와 과거 이력을 관리하고 확인할 수 있는 환경을 제공하기 위함.</td></tr>
  <tr><td><b>Approach</b></td><td>마이페이지' 또는 '거래 관리' 메뉴를 통해 전체 거래 리스트를 제공합니다. 사용자가 정보를 쉽게 찾을 수 있도록 '진행 중인 거래'와 '종료된 거래'를 구분하는 필터링 기능을 지원하며, 각 내역을 클릭하면 상세 페이지로 이동하여 리뷰 작성이나 연장 신청 같은 후속 액션을 연결합니다.</td></tr>
  <tr><td><b>Dynamics</b></td><td>사용자가 자신의 자산 활용 현황을 파악하고 싶을 때나, 현재 진행 중인 거래에 대해 수령/반납 확인 등 특정 절차를 밟기 위해 거래 관리 메뉴에 진입하는 시점에 작동합니다.</td></tr>
...
<table>
  ...
  <tr><td><b>Dynamics</b></td><td>오프라인 거래 현장에서 공급자가 물품을 전달하며 앱에서 '전달 완료' 버튼을 클릭할때 트리거됨 </td></tr>
...
<table>
  ...
  <tr><td><b>Dynamics</b></td><td>대여 기간 종료 시점에 수요자가 물품을 반납하고 '반납 완료'버튼을 클릭할 때 트리거됨.</td></tr>
...
<table>
  ...
  <tr><td><b>Dynamics</b></td><td>거래가 완료된 후 전 '리뷰 작성'버튼을 클릭할 때 트리거 됨.</td></tr>
